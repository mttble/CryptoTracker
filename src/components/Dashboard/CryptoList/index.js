    ...
    return (
        ...
        <a href={tradingViewUrl}>
            <tr className='list-row'>
                ...
                <td
                    className={`watchlist-icon-list ${coin.price_change_percentage_24h < 0 && "watchlist-icon-list-red"}`}
                    onClick={(e) => {
                        e.preventDefault();  // Prevent link navigation when clicking the watchlist icon
                        if (isCoinAdded) {
